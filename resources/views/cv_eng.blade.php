		    ...
		    <header class="resume-header pt-4 pt-md-0">
			    <div class="row">
				    <div class="col-block col-md-auto resume-picture-holder text-center text-md-start">
				        <img class="picture" src="{{url('/')}}/assets-cv/images/profile.jpg" alt="">
				    </div><!--//col-->
				    <div class="col">
					    <div class="row p-4 justify-content-center justify-content-md-between">
						    <div class="primary-info col-auto">
							    <h1 class="name mt-0 mb-1 text-white text-uppercase text-uppercase">NIKOLIUS</h1>
							    <div class="title mb-3">Full Stack Web Developer & Data Analyst</div>
					    ...
					    <section class="resume-section skills-section mb-5">
						    ...
						    <div class="resume-section-content">
						        <div class="resume-skill-item">
							        <h4 class="resume-skills-cat font-weight-bold">Technology Stack</h4>
							        <ul class="list-unstyled mb-4">
								        ...
								        <li class="mb-2">
								            <div class="resume-skill-name">AWS S3 (Simple Storage File)</div>
								        </li>
								        <li class="mb-2">
								            <div class="resume-skill-name">AWS Cognito (Authentication, Authorization, and User Management)</div>
								        </li>
							        </ul>
...
setTimeout(() => {
	const Toast = Swal.mixin({
	  ...
	  didOpen: (toast) => {
	  	toast.addEventListener('load', Swal.stopTimer);
	  }
	})
